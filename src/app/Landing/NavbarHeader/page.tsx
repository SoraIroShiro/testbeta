  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-start">
        <Image
          className=""
          style={{ width: 120, height: 40, margin: 15 }}
          src={Logo}
          alt="logo"
          unoptimized
        />
      ...
      {isMobile ? (
        ...
        <>
          ...
          <Link className="no-underline text-white justify-items-center font-sans font-bold bg-customBlue active:bg-customBlueHover items-center"
            href="/User/Login" 
            style={{
              margin: 5,
              width: 70,
